{ pkgs, lib, labAssets, hostSoftwarePackages, ... }:
let
  enabled = builtins.elem "ghostty" hostSoftwarePackages
    && builtins.elem "python3Packages.terminaltexteffects" hostSoftwarePackages;
in
{
