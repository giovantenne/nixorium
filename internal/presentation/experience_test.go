...
func TestShutdownResultDisclosesTechnicalDetailOnlyOnRequest(t *testing.T) {
	m := experienceFixture(2)
	m.screen = dashboardShutdownResult
	m.shutdown.result = domain.ShutdownApplyReport{
		State:       "partial",
		Unconfirmed: 1,
